...
//args: mine branchlength, frequency, blocks
...
public class BranchMineCommand extends Command {
    ...
    public String getShortDesc() {
        return "StripMine blocks";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The branch mine command allows you to tell Baritone to strip mine for certain blocks"
                "",
                ...
                "",
                "Usage:",
                "> branchmine <branchlength> <distancebetween> [blocks]",
